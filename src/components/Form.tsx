...
import { Col, DatePicker, FormProps, InputNumber, InputNumberProps, Row, Select, Slider, Space, Tooltip } from 'antd';
...
const travelStyleOptions = {
  'Aventura/Ao ar livre': 'Para aqueles interessados em caminhadas, acampamentos, esportes aquáticos e outras atividades aventureiras.',
  'Cultural/Histórico': 'Foco em museus, sítios históricos e experiências culturais.',
  Luxo: 'Hotéis de alto padrão, gastronomia refinada e experiências exclusivas.',
  Econômico: 'Acomodações acessíveis, atividades econômicas e opções de refeições econômicas.',
  Familiar: 'Atividades adequadas para todas as idades, acomodações adequadas para crianças e atrações.',
  Romântico: 'Escapadas românticas, atividades para casais, experiências especiais para dois.',
  'Bem-estar/Relaxamento': 'Retiro de spa, atividades de bem-estar, sessões de ioga e locais serenos.',
  'Comida e Bebida': 'Tours culinários, degustações de vinhos, experiências de culinária local.',
  ...
  'Natureza e Vida Selvagem': 'Parques nacionais, safáris de vida selvagem, jardins botânicos.',
  'Festival/Eventos': 'Participação em festivais locais, concertos, eventos esportivos ou outros grandes eventos.',
};

const onFinish: FormProps<FieldType>['onFinish'] = (values) => {
  const data = {
    ...values,travel_period: values.travel_period.map((date: Dayjs) => date.format('DD/MM/YYYY')),
  }
    ...
    <div className="form-container">
      ...
      >
        <Form.Item<FieldType>
          ...
          className="form-item"
        >
          <LoadScript googleMapsApiKey={'AIzaSyBtVM3Hv__-aJLFy76gC7A2AaQpYKG-1_U'} libraries={['places']}>
            <Autocomplete
